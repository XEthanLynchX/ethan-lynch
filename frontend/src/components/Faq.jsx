...
const FaqSection = () => {
  const faqs = [
    ...
    { question: 'What payment options do you provide?', answer: 'PayPal.' },
  ...
  return (
    <section className="py-16 md:py-24 lg:py-24 bg-white lg:pt-36">
      <div className="px-8 mx-auto max-w-7xl lg:px-16">
        <h3 className="mt-1 text-4xl font-bold text-gray-800 sm:mx-6 sm:text-3xl md:text-4xl lg:text-5xl text-center">
          Frequently Asked Questions
        </h3>
        <p className="text-xs font-bold text-green-400 uppercase sm:mx-6 text-center text-normal sm:font-bold mt-4 text-red">
        ...
        <div className="grid grid-cols-1 gap-0 md:grid-cols-2 md:gap-6 pt-10">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              {selectedFaq === index && (
                <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal text-red">{faq.answer}</p>
              )}
            </motion.div>
          ))}
        </div>
