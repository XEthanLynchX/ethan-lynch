...
const Programs = () => {
  return (
            ...
            <div className="w-full md:w-1/3 p-4 mt-20 transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-110">
              <div className="border-0 border-black rounded p-4 shadow-2xl bg-berige ">
                ...
                <div className='flex justify-center space-x-4'>
                 <button href="#Private" className="bg-gray hover:bg-blue text-white font-bold py-2 px-4 rounded transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-110 mt-2"> Learn More</button>
      ...
      <div className="border-2 border-black rounded shadow-md bg-berige flex flex-col md:flex-row items-center border-t-2 mt-20 text-black shadow-2xl ">
        ...
        <div className="w-full  md:w-1/2 p-4 border-b-6 md:border-8 border-black md:border-b-0 md:border-t-0 border-b-2 ">
          ...
          <ul className="custom-bullet list-inside text-2xl  leading-relaxed m-4 font-[merriweahter] font-semibold text-black">
