...
const Programs = () => {
  return (
      <div className="p-8 bg-berige text-white" id="programs">
          ...
          <div className="flex flex-wrap justify-around bg-berige">
            <div className="w-full md:w-1/3 p-4 mt-20">
              <div className="border-2 border-black rounded p-4 shadow-md bg-gray ">
                ...
                <div className='flex justify-center space-x-4'>
                 <button href="#Private" className="bg-blue hover:bg-blue text-white font-bold py-2 px-4 rounded transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-110 mt-2"> Learn More</button>
            ...
            <div className="w-full md:w-1/3 p-4 mt-20">
              <div className="border-2 border-black rounded p-4 shadow-md bg-gray">
                ...
                <div className='flex justify-center space-x-4'>
                  <button href="#Private" className="bg-blue  text-white font-bold py-2 px-4 rounded transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-110 mt-2"> Learn More</button>
                  <button href="#Private" className="bg-lightred  text-white font-bold py-2 px-4 rounded transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-110 mt-2"> Enquire</button>
                </div>
              </div>
            </div>
            <div className="w-full md:w-1/3 p-4 mt-20 mb-20">
              <div className="border-2 border-black rounded p-4 shadow-md bg-gray">
      ...
      <div className="border-2 border-black rounded shadow-md bg-gray flex flex-col md:flex-row items-center border-t-2 mt-20 text-white ">
        <div className="w-full  md:w-1/2 p-4 border-b-2  border-black md:border-b-0">
          <h3 className="text-6xl font-bold mb-4 font-[Merriweather] text-center mt-8">Private 1:1 Coaching</h3>
           <ul className="custom-bullet list-inside text-2xl text-white leading-relaxed m-4 font-[merriweahter] font-semibold">
        ...
        <div className="w-full  md:w-1/2 p-4 border-b-6 md:border-8 border-black md:border-b-0 md:border-t-0 border-b-2 ">
          <h3 className="text-6xl font-bold mb-4 font-[Merriweather] text-center  ">Custom Workout Plan</h3>
          <ul className="custom-bullet list-inside text-2xl text-black leading-relaxed m-4 font-[merriweahter] font-semibold text-white">
        ...
        <div className="w-full  md:w-1/2 p-4 border-b-2  border-black md:border-b-0 md:border-t-">
